...
const updateComment = async (req, res) => {
	...
	comment.update();
	res.status(StatusCodes.OK).json({ success: true, message: "Comment created!" });
};
...
const createMultipleDummyComments = async (req, res) => {
	...
	res.status(StatusCodes.CREATED).json({ success: true, message: "Comments Created!", createdComments });
};
